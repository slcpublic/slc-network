...
import com.liulishuo.okdownload.core.UtilsCompat;
...
public class DownloadOkHttp3ConnectionFixBug implements DownloadConnection, DownloadConnection.Connected {
    @NonNull
    ...
    DownloadOkHttp3ConnectionFixBug(@NonNull OkHttpClient client,
                                    @NonNull Request.Builder requestBuilder) {
        this.client = client;
        this.requestBuilder = requestBuilder;
    }

    DownloadOkHttp3ConnectionFixBug(@NonNull OkHttpClient client, @NonNull String url) {
    ...
    public String getResponseHeaderField(String name) {
        return UtilsCompat.urlDecode(response == null ? null : response.header(name));
    }
    ...
    public static class Factory implements DownloadConnection.Factory {
        ...
        public DownloadConnection create(String url) throws IOException {
            ...
            return new DownloadOkHttp3ConnectionFixBug(client, url);
        }
    }
}
